                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="doctor" type="radio" name="userType" value="doctor" class="@error('userType') is-invalid @enderror" name="'userType" value="{{ old('userType') }}" required autocomplete="userType" autofocus>
                                <label for="doctor">Médico</label><br>
                                <input id="patient" type="radio" name="userType" value="patient" class="@error('userType') is-invalid @enderror" name="'userType" value="{{ old('userType') }}" required autocomplete="userType" autofocus>
                        ...
                        <div class="form-group row">
                            <label for="collegiateNumber" class="col-md-4 col-form-label text-md-right">{{ __('Numero de colegiado') }}</label>

                            <div class="col-md-6">
                                <input id="collegiateNumber" type="text" class="form-control @error('collegiateNumber') is-invalid @enderror" name="collegiateNumber" value="{{ old('collegiateNumber') }}" autofocus>

                                @error('collegiateNumber')
                                <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                                @enderror
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="nuhsa" type="text" class="form-control @error('nuhsa') is-invalid @enderror" name="nuhsa" value="{{ old('nuhsa') }}" autofocus>
